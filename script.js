const skills = [
  { name: 'Python', icon: 'python.svg', level: 88 },
  { name: 'C#', icon: 'csharp.svg', level: 83 },
  { name: 'Java', icon: 'java.svg', level: 80 },
  { name: 'JavaScript', icon: 'javascript.svg', level: 69 },
  { name: 'HTML', icon: 'html.svg', level: 77 },
  ...
  { name: 'Git', icon: 'git.svg', level: 70 },
